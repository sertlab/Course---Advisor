        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <div class="post-preview">
                       ...
                       <li> <a href="courses.php?cat=1">Applications and foundations of computer science</a></li>
                       <li> <a href="courses.php?cat=2">Software and Information system enginnering</a></li>
                       <li> <a href="courses.php?cat=3">Computer Hardware and Architecture</a></li>
                       <li> <a href="courses.php?cat=4">Signals,Communications, and Networking</a></li> 
                       <li> <a href="courses.php?cat=5">Energy</a></li>
                       <li> <a href="courses.php?cat=6">Free of Specialization Areas</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p class="copyright text-muted">Copyright &copy; Course advisor 2016-Developed by Strezos Fanis</p>
                </div>
            </div>
        </div>
    </footer>
